...
from expy_tui.transaction.transaction_crud import TransactionCRUD, TransactionSQLite
...
class TestTransactionCRUD:
    ...
    @pytest.mark.order(1)
    def test_create_and_get_all_transactions(self,  inmemory_sqlite_db: TransactionCRUD,
    ...
    def test_create_transactions_failure(self,  inmemory_sqlite_db: TransactionCRUD,
                                         sample_transactions: list[Transaction]) -> None:
    ...
    def test_get_transaction_id_valid(self, inmemory_sqlite_db: TransactionCRUD,
                                      sample_transactions: list[Transaction]) -> None:
    ...
    def test_get_transaction_id_invalid(self, inmemory_sqlite_db: TransactionCRUD) -> None:

        id_invalid_output = inmemory_sqlite_db.get_transaction_id(25)

        assert id_invalid_output is None

    def test_update_transaction_success(self, inmemory_sqlite_db: TransactionCRUD,
                                        sample_transactions: list[Transaction]) -> None:
    ...
    def test_update_transaction_failure(self, inmemory_sqlite_db: TransactionCRUD,
                                        sample_transactions: list[Transaction]) -> None:
    ...
    def test_delete_transaction_success(self, inmemory_sqlite_db: TransactionCRUD,
                                        sample_transactions: list[Transaction]) -> None:
    ...
    def test_delete_transaction_failure(self, inmemory_sqlite_db: TransactionCRUD,
                                        sample_transactions: list[Transaction]) -> None:
